...
neededData <- data[, c("NativeLanguage", "BirthCountry" ,"OtherLanguages", "TestQ11", "TestQ12","TestQ13","TestQ14", "TestQ15")]
neededData <- neededData %>% filter_all(all_vars(!is.na(.)))
neededData$TotaalLagerOnderwijs <- (neededData$TestQ11 + neededData$TestQ12 + neededData$TestQ13 + neededData$TestQ14 + neededData$TestQ15)/5
