...
neededData <- data[, c("NativeLanguage", "BirthCountry" ,"OtherLanguages", "TestQ01", "TestQ02","TestQ03","TestQ04", "TestQ05")]
neededData <- neededData %>% filter_all(all_vars(!is.na(.)))
neededData$TotaalLagerOnderwijs <- (neededData$TestQ01 + neededData$TestQ02 + neededData$TestQ03 + neededData$TestQ04 + neededData$TestQ05)/5
...
t(alfa, "greater", neededData$TotaalLagerOnderwijs[neededData$NativeLanguage == 'Nederlands'], neededData$TotaalLagerOnderwijs[neededData$NativeLanguage == 'Other'])


# Math4IT <-> Birth Country
t(alfa, "greater", neededData$TotaalLagerOnderwijs[neededData$BirthCountry == 'Belgium'], neededData$TotaalLagerOnderwijs[neededData$BirthCountry == 'Other'])

# Math4IT <-> Other Languages
t(alfa, "greater", neededData$TotaalLagerOnderwijs[neededData$Nederlands == 'Yes'], neededData$TotaalLagerOnderwijs[neededData$Nederlands == 'No'])
